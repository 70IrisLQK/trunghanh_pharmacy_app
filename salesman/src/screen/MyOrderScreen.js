          ...
          {orderList.length > 0 ?
            (
                          ...
                          <View
                            ...
                            <View style={styles.orderItemContainer}>
                              <View style={{ display: 'flex', flexDirection: 'row' }}>
                                ...
                                <Text style={styles.subTitle}>{item.order_id.substring(0, 8)}</Text>
                              </View>
                              <View style={{ display: 'flex', flexDirection: 'row' }}>
                                <Text style={styles.title}>Thời gian đặt hàng: </Text>
                                <Text style={styles.subTitle}>{moment(item.created_at).format('DD/MM/YYYY')}</Text>
                              </View>
                              <View style={{ display: 'flex', flexDirection: 'row' }}>
                                <Text style={styles.title}>Tổng tiền : </Text>
                                <Text style={styles.subTitle}>{(item.total_price).toString()
              ...
              <View
                ...
                <Text style={styles.titleOrder}>Bạn chưa có đơn hàng nào rồi</Text>
              </View>
            )}
        </View>
