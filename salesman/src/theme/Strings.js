...
export default {
  ...
  login_text: 'SignIn',
  login_text1: 'Trung Hanh DMS',
  login_text2: 'Hệ thống bán hàng phân phối',
  ...
  usernameHint: 'Nhập tài khoản',
  namePharmacyHint: 'Tên đại lý',
  ...
  usernameErrorMessage: 'Thông tin này là bắt buộc. Vui lòng nhập đầy đủ.',
  namePharmacyErrorMessage: 'Thông tin này là bắt buộc. Vui lòng nhập đầy đủ.',
  passwordErrorMessage: 'Thông tin này là bắt buộc. Vui lòng nhập đầy đủ.',
  ...
  searchHint: 'Tìm sản phẩm trên Trung Hạnh...',
};
